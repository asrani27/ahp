    ...
    <div class="col-md-12">
        <div class="box box-danger">
          <div class="box-header">
            ...
            <div class="box-tools">
              <a href="/superadmin/user/create" class="btn btn-flat btn-sm btn-danger"><i class="fa fa-plus"></i> Tambah Data</a>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              <tr>
                ...
                <td>{{$item->username}}</td>
                <td>
                  <a href="/superadmin/user/edit/{{$item->id}}" class="btn btn-flat btn-sm btn-danger"><i class="fa fa-edit"></i> Edit</a>
